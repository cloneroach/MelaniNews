...
$filesuffix='NpAdvMainFea'; //The last part of this file name - ie. the name of this manipulation file that you enter in a Viva call.

$newwidth=495;  //The thumbnail width
$newheight=270;  //The thumbnail height
...
if($width==$newwidth AND $height==$newheight){ $onlyresize=1; }
