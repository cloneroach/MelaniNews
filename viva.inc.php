 ...
 * viva.inc.php
 * 
 * Ciore Viva Thumbs Utility file for dynamically resizing images on the fly
 * @author      Tim Waddell
 * @version     4.0 
 * Based On Thumbnail Class by     Ian Selby (ian@gen-x-design.com)
 */
class Thumbnail {
    /**
     ...
     * @return Thumbnail
     */
    function Thumbnail($fileName,$cat) {
