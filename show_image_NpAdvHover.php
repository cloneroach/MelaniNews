...
$filesuffix='NpAdvHover'; //The last part of this file name - ie. the name of this manipulation file that you enter in a Viva call.

$newwidth=600;  //The thumbnail width
$newheight=80;  //The thumbnail height
...
$border=1;  //Border on or off   - true or false (Only works if reflection is set to 1 ( you can set reflectheight to 0 to have boder but no relfection depth)
$intellicrop=0; //Intelligent cropping on or off - 1 = On, 0 = off - OFF means the image is cropped from the very top not the logical centre

$onlyresize=1; //dont crop just resize the image. This preserves the original image means only newwidth or newheight attribute is used to keep image in proportion
$onlywhat="width"; //If onlyresize is ON (1) then you must say which dimension to use w or h (width or height)
